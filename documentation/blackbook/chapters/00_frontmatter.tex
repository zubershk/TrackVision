...
\thispagestyle{plain}
\begin{center}
    {\Large \bfseries \color{trackvisiondark} Certificate}\\[1cm]
\end{center}
...
\thispagestyle{plain}
\begin{center}
    {\Large \bfseries \color{trackvisiondark} Declaration}\\[1cm]
\end{center}
...
\thispagestyle{plain}
\begin{center}
    {\Large \bfseries \color{trackvisiondark} Abstract}\\[1cm]
\end{center}
...
\thispagestyle{plain}
\begin{center}
    {\Large \bfseries \color{trackvisiondark} Acknowledgement}\\[1cm]
\end{center}
