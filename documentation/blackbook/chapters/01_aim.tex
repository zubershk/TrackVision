...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Full 6×6 covariance Kalman filter (constant acceleration model)
    ...
    \item \textbf{Browser-native video acquisition:} Capture live camera feed via \texttt{getUserMedia()} and process frames using \texttt{OffscreenCanvas} at 640×640 letterboxed resolution with zero-copy buffer transfer to workers.
