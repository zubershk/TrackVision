...
\begin{itemize}
    \item \textbf{Identity Continuity:} Tracks maintain stable IDs during smooth motion; re-association succeeds after brief occlusion ($\leq$ 5 frames).
