...
\midrule
Resolution & Variable (camera: up to 1280x720; file: any); letterboxed to 640x640 internally \\
...
\begin{enumerate}
    ...
    \item \textbf{Planar Conversion:} RGBA $\to$ float32 CHW (3 x 640 x 640), normalized by 1/255.
...
\begin{itemize}
    ...
    \item Sample video: \texttt{one-by-one-person-detection.mp4} (Intel IoT DevKit sample, ~3.3 MB, 1920x1080, 30 FPS, single person walking).
\end{itemize}
...
Resolution & Variable; processed at 640x640 letterboxed \\
